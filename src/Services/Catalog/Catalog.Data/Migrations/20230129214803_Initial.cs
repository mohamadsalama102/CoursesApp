        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhoIsThisCourseFor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsUnderAdminReview = table.Column<bool>(type: "bit", nullable: false),
                    IsRejected = table.Column<bool>(type: "bit", nullable: false),
                    Level = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Language = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubCategoryId = table.Column<int>(type: "int", nullable: false),
                    Discount_UsePercentage = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Discount_StartDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Discount_EndDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Discount_IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePreviewVideos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoursePreviewVideos_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningObjective = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentCourses_ApplicationUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "ApplicationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DownloadableFiles_Lectures_LectureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedLectureId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Questions_Lectures_RelatedLectureId",
                        column: x => x.RelatedLectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subtitles_LectureVideos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Answers", x => new { x.Order, x.QuestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePreviewVideos_CourseId",
                table: "CoursePreviewVideos",
                column: "CourseId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DownloadableFiles_LectureId",
                table: "DownloadableFiles",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_Lectures_Order_SectionId",
                table: "Lectures",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_RelatedLectureId",
                table: "Questions",
                column: "RelatedLectureId");
